...
// Imagen embebida directamente para funcionar fuera de Lovable Cloud
const TUTOR_AVATAR_URL = 'https://know-world-map.lovable.app/__l5e/assets-v1/39dda0b7-f732-4397-a6f9-3e140f718928/tutor-avatar.png'
...
export function AiTutor({ context }: { context?: string }) {
  ...
  if (!open)
    return (
      ...
      >
        <img src={TUTOR_AVATAR_URL} alt="" className="size-7 rounded-full object-cover" /> Tutor IA
      </button>
    )
  ...
  return (
    <div className="fixed bottom-20 right-4 z-40 flex h-[32rem] w-[min(94vw,24rem)] flex-col rounded-xl border border-border bg-popover shadow-2xl md:bottom-6">
      <header className="flex items-center justify-between border-b border-border px-4 py-3">
        <span className="flex items-center gap-2 text-sm font-semibold"><img src={TUTOR_AVATAR_URL} alt="" className="size-7 rounded-full object-cover" /> Tutor REALPOLITICS</span>
